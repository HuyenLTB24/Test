...
QT_MOC_LITERAL(3, 26, 8), // "LogEntry"
QT_MOC_LITERAL(4, 35, 5), // "entry"
QT_MOC_LITERAL(5, 41, 14), // "logFileRotated"
QT_MOC_LITERAL(6, 56, 11), // "newFileName"
QT_MOC_LITERAL(7, 68, 5), // "flush"
QT_MOC_LITERAL(8, 74, 16) // "flushPendingLogs"

    },
    "LogManager\0logEntryAdded\0\0LogEntry\0"
    "entry\0logFileRotated\0newFileName\0flush\0"
    "flushPendingLogs"
};
...
void LogManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->logEntryAdded((*reinterpret_cast< const LogEntry(*)>(_a[1]))); break;
        case 1: _t->logFileRotated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->flush(); break;
        case 3: _t->flushPendingLogs(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LogManager::*)(const LogEntry & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogManager::logEntryAdded)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogManager::logFileRotated)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LogManager::logEntryAdded(const LogEntry & _t1)
{
...
// SIGNAL 1
void LogManager::logFileRotated(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
